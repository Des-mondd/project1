...
JLabel personlid;
    ...
    MainFrame() throws Exception {
      ...
      controller=new Performcollection();
        ...
        personlable=new JLabel("Desmond Twum");
        personlid=new JLabel("10905743");
      personlable.setForeground(Color.white);
        personlid.setForeground(Color.white);
